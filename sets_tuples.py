...
# print(tuple2.index("cherry")) # 2
# print(tuple3.index("banana")) # 3

# #convert a tuple to a list
# print(list(tuple1)) # [1, 2, 3, 4, 5]

# #convert a list to a tuple
# print(tuple(list(tuple1))) # (1, 2, 3, 4, 5)
...
# # Output the result
# print(f"Total number of V's: {total_v} ")
...
# print(sample_list[2][2]) # gets 9
# print(sample_list[1][2]) # gets 6
# print(sample_list[1][0]) # gets 4
# print(sample_list[0][1]) # gets 2
...
# print(sample_list_of_dicts["ducts"][2]["age"])
